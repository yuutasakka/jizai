...
export const BoltCircleIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="2"/>
    <path d="M13 3L4 14H11L10 21L19 10H12L13 3Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

export const ArrowPathIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
export const ExclamationBubbleIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
export const SparklesIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path d="M9.937 15.5A2 2 0 0 0 8.5 14.063L8.5 12.937A2 2 0 0 0 9.937 11.5L11.063 11.5A2 2 0 0 0 12.5 12.937L12.5 14.063A2 2 0 0 0 11.063 15.5L9.937 15.5Z" stroke="currentColor" strokeWidth="1.5"/>
    <path d="M17.5 8.5A1.5 1.5 0 0 0 16 7V6A1.5 1.5 0 0 0 17.5 4.5H19A1.5 1.5 0 0 0 20.5 6V7A1.5 1.5 0 0 0 19 8.5H17.5Z" stroke="currentColor" strokeWidth="1.5"/>
    <path d="M6 5.5A1 1 0 0 0 5 4.5V4A1 1 0 0 0 6 3H6.5A1 1 0 0 0 7.5 4V4.5A1 1 0 0 0 6.5 5.5H6Z" stroke="currentColor" strokeWidth="1.5"/>
    <path d="M6 20.5A1 1 0 0 0 5 19.5V19A1 1 0 0 0 6 18H6.5A1 1 0 0 0 7.5 19V19.5A1 1 0 0 0 6.5 20.5H6Z" stroke="currentColor" strokeWidth="1.5"/>
    <path d="M18.5 20.5A1 1 0 0 0 17.5 19.5V19A1 1 0 0 0 18.5 18H19A1 1 0 0 0 20 19V19.5A1 1 0 0 0 19 20.5H18.5Z" stroke="currentColor" strokeWidth="1.5"/>
  </svg>
);
