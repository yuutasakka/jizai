      ...
      <div className="px-6 py-8">
        ...
        <div className="mb-12">
          <div 
            ...
            className="relative bg-gray-50 border-2 border-dashed border-gray-300 rounded-xl p-12 text-center cursor-pointer hover:bg-gray-100 transition-colors"
          >
            <div className="mb-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {editingOptions.map((option) => (
              <div
                ...
                className="bg-white border border-gray-200 rounded-xl p-6 text-center cursor-pointer hover:shadow-lg hover:border-blue-300 transition-all"
              >
